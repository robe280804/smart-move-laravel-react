            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8 items-stretch">
                    {PRICING_TIERS.map((tier) => {
                        ...
                        const textMuted = tier.highlighted ? "text-blue-200" : tier.name === "Pro" ? "text-slate-400" : "text-slate-400";
                        ...
                        return (
                            <div
                                key={tier.name}
                                className={`relative rounded-2xl p-8 flex flex-col shadow-lg ${tier.cardStyle} ${tier.highlighted ? "scale-105 shadow-2xl shadow-indigo-200 z-10" : ""}`}
                            >
                                {/* Badge */}
                                {tier.badge && (

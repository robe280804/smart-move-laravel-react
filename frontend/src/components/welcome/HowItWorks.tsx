                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 relative">
                    ...
                    {STEPS.map((step, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                className="group relative z-10 flex flex-col items-center text-center p-6 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300 cursor-default"
                            >
                                {/* Number bubble — scales and brightens on hover */}

...
class OutputPrompt
{
    ...
    public static function content(): array
    {
        return [
            ...
            'Every exercise object must include the "name" field with a clear, standard exercise name (e.g. "Barbell Back Squat", "Dumbbell Bicep Curl").',
            'Preferred block names: Warmup, Main, Cool-down, Mobility Flow, Strength, Accessory, Core, Circuit, Conditioning.',
        ];
    }
}
